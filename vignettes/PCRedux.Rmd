...
legend("topright", c("Cluster 1", "Cluster 2"), pch = 15, col = colors, 
       bty = "n")

# Overview of clusters and corresponding detection chemistry

eghp <- rep(1.3, length(cl$cluster))
...
text(c(18.75, 57.5), c(1.8, 1.8), c("EvaGreen", "Hydrolysis\nprobes"))
```
...
# Load only the amplification curves from the htPCR data set that could be 
# uniquely assigned to a class.
