...
```{r, echo=TRUE, fig.cap="\\label{earlyreg_slopes}Amplification curves from the `competimer` dataset (\\texttt{qpcR} package). The amplification curves show different slopes in the early phase (cycle 1 to 10) of the qPCR. B) Clusters of observations according to their slope and intercept. The `competimer` dataset (\\texttt{qpcR} package) was used. The amplification curves show different slopes in the early phase (cycle 1 to 10) of the qPCR. Both the slope and the intercept were used for a cluster analysis (k-means).", fig.height=4}
options(warn = -1)
library(PCRedux)
...
matplot(
  data[, 1], data[, -1], col = 1, pch = 19, lty = 1, type = "l",
  xlab = "Cycle", ylab = "RFU", main = ""
)
mtext("A", cex = 1.25, side = 3, adj = 0, font = 2)
...
matplot(data[range, 1], data[range, which(cl[["cluster"]] == i) + 1], xlab = "Cycle", 
        ylab = "RFU", main = "", ylim = c(0, y_max),
