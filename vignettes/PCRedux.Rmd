...
library(PCRedux)
data(RAS002_RAS003_amp)

amp_data <- RAS002_RAS003_amp
...
matplot(
  ...
  col = as.factor(human_classification), lwd = 2
)
...
cdplot(as.factor(human_classification) ~ res_ac, xlab="Autocorrelation", 
       ylab="Decision")
