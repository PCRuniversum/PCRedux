...
Sometimes it is difficult even for a human expert to classify the amplification curves unambiguously and reproducible. To illustrate this matter an example for the analysis and classification of the `htPCR` data set is given in \autoref{section_decision_mode}.
