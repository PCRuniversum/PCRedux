...
matplot(fdata[, 1], fdata[, -1], type="l", lty=1, lwd=2, ylab="RFU", xlab="Cycle")

head(data, 3)
```

Printout of all measured samples, their rating be two humans (rater 1 and rater 
...
[@ritz_qpcr:_2008, @spiess_highly_2008].
