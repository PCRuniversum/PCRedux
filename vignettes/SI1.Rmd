...
The PDF version of this document is available [online](https://github.com/devSJR/PCRedux/blob/master/docs/articles/SI1.pdf).
...
The aim of the study is to provide software tools and algorithms, which assist qPCR users during the analysis and quality management of their data. In particular, this study shows how it is possible to automatically detect hook effects (see @barratt_improving_2002) or hook effect-like curvatures. 
...
made available in the CSV or RDML format [@roediger_enabling_2017] for vendor 
