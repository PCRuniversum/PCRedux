...
The aim of the study is to provide software tools and algorithms, which assist qPCR users during the analysis of their data. In particular, this study shows how it is possible to automatically detect hook effects (see @barratt_improving_2002) or hook effect-like curvatures. 
